...
{
    /// <summary>
    ///     Debug class that is exposed to the lua scripts by default, allowing debug
    ///     tools for lua script debugging
    /// </summary>
    [MoonSharpUserData, Serializable,]
    public class Debug
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="name">
        ///     The name of the lua script that is initializing the debug
        ///     object
        /// </param>
        [MoonSharpHidden]
